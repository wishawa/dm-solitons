...
for i = 1:4
	simulate(100, 100.0, 96, -1E-84, @(Spaces, simConsts) {...
		giveVelocity(Spaces, solitonNodelessSi(Spaces, [0 -5 0], 2.0, [-1 1i 0], simConsts), [0 0 0], simConsts),...
		giveVelocity(Spaces, solitonNodelessSi(Spaces, [0 5 0], 4.0, [1 1 1], simConsts), [0 0 0], simConsts),...
		% giveVelocity(Spaces, solitonNodelessSi(Spaces, [0 10 0], 5.0, [1 1 1], simConsts), [0 0 0], simConsts),...
	}, 8, 8, "outputs/2022-07-12/single-r0.6-soliton-96,long,dto" + i, 4000 * i, false, i);
end
