...
simulate(100, 100.0, 144, -1E-84, @(Spaces, simConsts) {...
	giveVelocity(Spaces, solitonNodelessSi(Spaces, [0 -10 0], 3.0, [1 0 0], simConsts), [0 0 0], simConsts),...
	giveVelocity(Spaces, solitonNodelessSi(Spaces, [0 10 0], 3.0, [0 1i 0], simConsts), [0 0 0], simConsts),...
	giveVelocity(Spaces, solitonNodelessSi(Spaces, [10 0 0], 3.0, [1i 0 0], simConsts), [0 0 0], simConsts),...
	giveVelocity(Spaces, solitonNodelessSi(Spaces, [-10 0 0], 3.0, [0 1 0], simConsts), [0 0 0], simConsts),...
}, 8, 12, "outputs/2022-07-06/3.0x4-attractive", 20000, false);
